  ...
  require_once('connectvars.php');
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
         ...
         $query = "UPDATE Department SET Name='$name', Location='$address', Phone='$phone' WHERE Id='$id'";
...
<?php include_once('header.php'); ?>
  ...
  <div class="container" style="display:none;">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="myupdatedept.php?id=<?php echo $id?>" method="post">
                     <div class="control-group <?php echo !empty($nameError)?'error':'';?>">
                        <label class="control-label">Department Name</label>
                        <div class="controls">
                            <input name="name" type="text" class="form-control"  placeholder="First Name" value="<?php echo !empty($name)?$name:'';?>">
