  ...
  if(isset($_SESSION['adminornot'])) {
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            echo $y;
            $dbc = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
            $query = "INSERT INTO Outpatient Values(0, '$y', '$doback')";
            $result = mysqli_query($dbc, $query);
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Create an OUT Patients</h3>
                    </div>
             
                    <form class="form-horizontal" action="createoutpatient.php" method="post">
                    ...
                    <div class="control-group">
                     ...
                     <div class="control-group">
                      ...
                      <div class="control-group">
                      <label class="control-label">Back Visiting Date</label>
                      <div class="controls">
                         <input  type="text" name="doback" placeholder="click to show datepicker"  id="example3">
                      </div>
                    </div>
