   ...
   if(isset($_SESSION['adminornot'])) {
    ...
    if ( !empty($_POST)) {
        ...
        if (((!empty($depm)) && (!empty($depw))) || ((empty($depm)) && (!empty($depw))) || (empty($depw) && !empty($depm)) ) {
             if ($depw != $depm) {
                  $depError = 'Work and Manage do not manage';
                  $valid = false;
             }
        }
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="updatephysician.php?id=<?php echo $id?>" method="post">
                     ...
                     <div class="control-group <?php echo !empty($depError)?'error':'';?>">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="deg" type="text"  placeholder="Degree" value="<?php echo !empty($deg)?$deg:'';?>">
                        </div>
                      </div>
                      <div class="control-group">
                        <label class="control-label">Speciality</label>
                        <div class="controls">
                            <input name="spec" type="text"  placeholder="Speciality" value="<?php echo !empty($spec)?$spec:'';?>">
                        </div>
                      </div>
