<?php
    ...
    if ( null==$id ) {
        header("Location: myreadout.php");
    } else {
        $dbc = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
        $query = "SELECT * from Persons where Id = '$id'";
        $result = mysqli_query($dbc, $query);
        $data = mysqli_fetch_array($result);
        $query = "Select * from Persons inner join Patient on Patient.PId=Persons.Id inner join Outpatient on Outpatient.PtId=Patient.Id where PId='$id'";
        $result = mysqli_query($dbc, $query);
