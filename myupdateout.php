...
<body>
    ...
    <div class="container" style="display:none;">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="updateoutpatient.php?id=<?php echo $id?>" method="post">
                     ...
                     <div class="control-group">
                      ...
                      <div class="control-group">
                       ...
                       <div class="controls">
                          <input  type="text" name="doback" placeholder="click to show datepicker"  id="example3" value="<?php echo !empty($doback)?$doback:'';?>">
                       </div>
                     </div>
                      ...
                      <div class="form-actions">
                          ...
                          <a class="btn" href="mypatients.php">Back</a>
                        </div>
                    </form>
                </div>
