   ...
   if(isset($_SESSION['adminornot'])) {
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
         ...
         $x = $row['Id'];
         $query = "UPDATE Outpatient SET BackDate='$doback' where PtId = '$x'";
         mysqli_query($dbc, $query);
         mysqli_close($dbc);
         header("Location: mypatients.php");
      }
        ...
        $y = $data2['Id'];
        $query = "SELECT * from Outpatient where PtId='$y'";
        $result2 = mysqli_query($dbc, $query);
        $data3 = mysqli_fetch_array($result2);
        $doback = $data3['BackDate'];
        if($gender == 'Male') {
...
<body>
    ...
    <div class="container" style="display:none;">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Update Out Patient Info.</h3>
                    </div>
             
                    <form class="form-horizontal" action="myupdateout.php?id=<?php echo $id?>" method="post">
                     <div class="control-group <?php echo !empty($nameError)?'error':'';?>">
                      ...
                      <div class="control-group <?php echo !empty($dobError)?'error':'';?>">
                       ...
                       <div class="controls">
                          <input  type="text" name="dob" class="form-control" placeholder="click to show datepicker"  id="example1" value="<?php echo !empty($dob)?$dob:'';?>">
                       </div>
                     </div>
                     <div class="control-group">
                     ...
                     <div class="control-group">
                      ...
                      <div class="control-group">
                       ...
                       <div class="control-group">
                       <label class="control-label">Date of Visiting Back</label>
                       <div class="controls">
                          <input  type="text" name="doback"  class="form-control" placeholder="Click To Select Date"  id="example3" value="<?php echo !empty($doback)?$doback:'';?>">
                       </div>
                     </div>
                      ...
                      <div class="form-actions">
                          ...
                          <a class="btn btn-primary" href="mypatients.php">Back</a>
                        </div>
                    </form>
                </div>
